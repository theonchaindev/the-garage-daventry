    ...
    <>
      ...
      <section style={{ background: "var(--brand)", paddingTop: "5rem", paddingBottom: "5rem" }}>
        <div className="wrap">
          ...
          <h1 style={{ color: "#fff", marginBottom: "1.25rem" }}>Contact Us</h1>
      ...
      <section className="bg-white section">
        <div className="wrap">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: "5rem" }}>
            ...
            {/* Info column */}
            <div>
              <h3 style={{ color: "var(--dark)", marginBottom: "2.5rem" }}>Contact Information</h3>
              ...
              {[
                ...
                <div key={i.label} style={{ marginBottom: "2rem", paddingBottom: "2rem", borderBottom: "1px solid var(--border)" }}>
                  <div style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--mid)", marginBottom: "0.4rem" }}>{i.label}</div>
                  {i.href ? (
                    <a href={i.href} style={{ color: "var(--dark)", fontWeight: 600, fontSize: "1.1rem", display: "block", marginBottom: "0.25rem" }}>{i.val}</a>
                  ) : (
                    <div style={{ color: "var(--dark)", fontWeight: 600, fontSize: "1.1rem", marginBottom: "0.25rem" }}>{i.val}</div>
                  )}
                  <div style={{ color: "var(--mid)", fontSize: "0.875rem" }}>{i.sub}</div>
                </div>
              ))}

              <div style={{ background: "var(--cream)", borderRadius: "var(--radius)", padding: "1.75rem", marginBottom: "2rem" }}>
            ...
            {/* Form column */}
            <div>
              <h3 style={{ color: "var(--dark)", marginBottom: "2.5rem" }}>Send a Message</h3>
